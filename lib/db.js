...
var subjectSchema = new Schema({
    xy: { type: String, default: "未知" },
    kch: { type: String, default: "未知" },
    kcm: { type: String, default: "未知" },
    kxh: { type: String, default: "未知" },
    js: { type: String, default: "未知" },
    xf: { type: String, default: "未知" },
    sj: { type: String, default: "未知" },
    dd: { type: String, default: "未知" },
    zc: { type: String, default: "未知" },
    bj: { type: String, default: "未知" },
    kcsx: { type: String, default: "未知" },
	semester:String
});
