(function() {
	...
	window.blockies = {
		create: function(a) {
			a = a || {};
			for (var c = a.size || 10, k = a.scale || 5, e = a.seed || Math.random().toString(36).substr(2), g = a.bgcolor || "#fff", b = m = 0; b < e.length; b += 2) {
				var f = e.charCodeAt(b) << 8 | e.charCodeAt(b + 1);
				m ^= f
			}(a = a.color) || (a = Math.floor(360 * l()), e = 50 * l() + 50 + "%", b = 60 * l() + 20 + "%", a = "hsl(" + a + "," + e + "," + b + ")");
			e = a;
			b = Math.ceil(c / 2);
			f = c - b;
			a = [];
